...
This repository presents the **production technology, systems thinking, and workflow architecture** behind **Our Perfect Wedding**, broadcast across **DStv · Mzansi Magic · Channel 161**.
...
* **RESULT**: Delivered 100% compliant broadcast-ready episodic masters meeting Mzansi Magic Channel 161 transmission standards across high-volume weekly delivery schedules.
* **CHALLENGE**: Managing large multicam uncompressed camera media, tight turnaround post-production windows, and exacting technical broadcast QC specs without transmission delays.
* **CONTRIBUTION**: Directed the digital intermediate (DI) workflow across precision colour correction, episodic colour grading, online editing, title integration, and final technical QC.
* **DELIVERY**: Broadcast transmission masters packaged to MultiChoice/DStv technical specifications with EBU R128 loudness compliance and archive asset preservation.
