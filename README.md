# Our Perfect Wedding — Production Engineering & Workflow Architecture
## DStv · Mzansi Magic · Channel 161 · Film & TV · Client: Connect TV

![Our Perfect Wedding Banner](assets/OPW-fin.webp)
...
In this repository, I present the **production technology, systems thinking, and workflow architecture** behind my work on **Our Perfect Wedding**, broadcast across **DStv · Mzansi Magic · Channel 161**.
...
* **RESULT**: I delivered 100% compliant broadcast-ready episodic masters meeting Mzansi Magic Channel 161 transmission standards across high-volume weekly delivery schedules.
* **CHALLENGE**: I had to manage large multicam uncompressed camera media, tight turnaround post-production windows, and exacting technical broadcast QC specifications without transmission delays.
* **CONTRIBUTION**: I directed the digital intermediate (DI) workflow across precision colour correction, episodic colour grading, online editing, title integration, and final technical QC.
* **DELIVERY**: I delivered broadcast transmission masters packaged to MultiChoice/DStv technical specifications with EBU R128 loudness compliance and archival asset preservation.
...
├── assets/
│   └── OPW-fin.webp                 ← Production visual master
├── diagrams/
